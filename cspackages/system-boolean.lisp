...
;;; Creation Date: 2026-06-30T03:10:15Z
...
(cl:defconstant <creation> "2026-06-30T03:10:15Z")
...
(cl:defun compare-to (obj cl:&rest args)
  ...
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Boolean") obj) "CompareTo" args))
...
(cl:defun equals (obj cl:&rest args)
  ...
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Boolean") obj) "Equals" args))
...
(cl:defun to-string (obj cl:&rest args)
  ...
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Boolean") obj) "ToString" args))
