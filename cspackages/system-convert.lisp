...
;;; Creation Date: 2026-06-28T22:30:15Z
...
(define-symbol-macro db-null (dotnet:static <type-str> "DBNull"))
(setf (documentation 'db-null 'variable) "A constant that represents a database column that is absent of data; that is, database null.")

(defun change-type (&rest args)
  "Passthrough for System.Convert.ChangeType overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ChangeType" args))

(defun change-type-object-type-code (value type-code)
...
"
  (dotnet:static <type-str> "ChangeType" (the (dotnet "System.Object") value) (the (dotnet "System.TypeCode") type-code)))

(defun change-type-object-type (value conversion-type)
...
"
  (dotnet:static <type-str> "ChangeType" (the (dotnet "System.Object") value) (the (dotnet "System.Type") conversion-type)))

(defun change-type-object-type-code-i-format-provider (value type-code provider)
...
"
  (dotnet:static <type-str> "ChangeType" (the (dotnet "System.Object") value) (the (dotnet "System.TypeCode") type-code) (the (dotnet "System.IFormatProvider") provider)))

(defun change-type-object-type-i-format-provider (value conversion-type provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ChangeType" (the (dotnet "System.Object") value) (the (dotnet "System.Type") conversion-type) (the (dotnet "System.IFormatProvider") provider)))

(defun from-base64-char-array (in-array offset length)
...
"
  (dotnet:static <type-str> "FromBase64CharArray" (the (dotnet "System.Char[]") in-array) (the (dotnet "System.Int32") offset) (the (dotnet "System.Int32") length)))

(defun from-base64-string (s)
...
"
  (dotnet:static <type-str> "FromBase64String" (the (dotnet "System.String") s)))

(defun from-hex-string (s)
...
Parameters:
  - s (System.String): The string to convert.
"
  (dotnet:static <type-str> "FromHexString" (the (dotnet "System.String") s)))

(defun get-type-code (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface.
"
  (dotnet:static <type-str> "GetTypeCode" (the (dotnet "System.Object") value)))

(defun is-db-null (value)
...
"
  (dotnet:static <type-str> "IsDBNull" (the (dotnet "System.Object") value)))

(defun to-base64-char-array (&rest args)
  "Passthrough for System.Convert.ToBase64CharArray overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToBase64CharArray" args))

(defun to-base64-char-array-byte[]-int32-int32-char[]-int32 (in-array offset-in length out-array offset-out)
...
"
  (dotnet:static <type-str> "ToBase64CharArray" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset-in) (the (dotnet "System.Int32") length) (the (dotnet "System.Char[]") out-array) (the (dotnet "System.Int32") offset-out)))

(defun to-base64-char-array-byte[]-int32-int32-char[]-int32-base64-formatting-options (in-array offset-in length out-array offset-out options)
...
"
  (dotnet:static <type-str> "ToBase64CharArray" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset-in) (the (dotnet "System.Int32") length) (the (dotnet "System.Char[]") out-array) (the (dotnet "System.Int32") offset-out) (the (dotnet "System.Base64FormattingOptions") options)))

(defun to-base64-string (&rest args)
  "Passthrough for System.Convert.ToBase64String overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToBase64String" args))

(defun to-base64-string-byte[] (in-array)
...
"
  (dotnet:static <type-str> "ToBase64String" (the (dotnet "System.Byte[]") in-array)))

(defun to-base64-string-byte[]-base64-formatting-options (in-array options)
...
Parameters:
  ...
  - options (System.Base64FormattingOptions): System.Base64FormattingOptions.InsertLineBreaks to insert a line break every 76 characters, or System.Base64FormattingOptions.None to not insert line breaks.
"
  (dotnet:static <type-str> "ToBase64String" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Base64FormattingOptions") options)))

(defun to-base64-string-byte[]-int32-int32 (in-array offset length)
...
Parameters:
  ...
  - length (System.Int32): The number of elements of inArray to convert.
"
  (dotnet:static <type-str> "ToBase64String" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset) (the (dotnet "System.Int32") length)))

(defun to-base64-string-byte[]-int32-int32-base64-formatting-options (in-array offset length options)
...
Parameters:
  ...
  - options (System.Base64FormattingOptions): System.Base64FormattingOptions.InsertLineBreaks to insert a line break every 76 characters, or System.Base64FormattingOptions.None to not insert line breaks.
"
  (dotnet:static <type-str> "ToBase64String" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset) (the (dotnet "System.Int32") length) (the (dotnet "System.Base64FormattingOptions") options)))

(defun to-boolean (&rest args)
  "Passthrough for System.Convert.ToBoolean overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToBoolean" args))

(defun to-boolean-object (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Object") value)))

(defun to-boolean-boolean (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Boolean") value)))

(defun to-boolean-s-byte (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.SByte") value)))

(defun to-boolean-char (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Char") value)))

(defun to-boolean-byte (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Byte") value)))

(defun to-boolean-int16 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Int16") value)))

(defun to-boolean-u-int16 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.UInt16") value)))

(defun to-boolean-int32 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Int32") value)))

(defun to-boolean-u-int32 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.UInt32") value)))

(defun to-boolean-int64 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Int64") value)))

(defun to-boolean-u-int64 (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.UInt64") value)))

(defun to-boolean-string (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.String") value)))

(defun to-boolean-single (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Single") value)))

(defun to-boolean-double (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Double") value)))

(defun to-boolean-decimal (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Decimal") value)))

(defun to-boolean-date-time (value)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.DateTime") value)))

(defun to-boolean-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-boolean-string-i-format-provider (value provider)
...
"
  (dotnet:static <type-str> "ToBoolean" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-byte (&rest args)
  "Passthrough for System.Convert.ToByte overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToByte" args))

(defun to-byte-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Object") value)))

(defun to-byte-boolean (value)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Boolean") value)))

(defun to-byte-byte (value)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Byte") value)))

(defun to-byte-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Char") value)))

(defun to-byte-s-byte (value)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.SByte") value)))

(defun to-byte-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Int16") value)))

(defun to-byte-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.UInt16") value)))

(defun to-byte-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Int32") value)))

(defun to-byte-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.UInt32") value)))

(defun to-byte-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Int64") value)))

(defun to-byte-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.UInt64") value)))

(defun to-byte-single (value)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Single") value)))

(defun to-byte-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Double") value)))

(defun to-byte-decimal (value)
...
Parameters:
  - value (System.Decimal): The number to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Decimal") value)))

(defun to-byte-string (value)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.String") value)))

(defun to-byte-date-time (value)
  "Calls System.Convert.ToByte ToByte(DateTime) -> Byte. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.DateTime") value)))

(defun to-byte-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-byte-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-byte-string-int32 (value from-base)
...
"
  (dotnet:static <type-str> "ToByte" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-char (&rest args)
  "Passthrough for System.Convert.ToChar overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToChar" args))

(defun to-char-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Object") value)))

(defun to-char-boolean (value)
  "Calls System.Convert.ToChar ToChar(Boolean) -> Char. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Boolean") value)))

(defun to-char-char (value)
...
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Char") value)))

(defun to-char-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.SByte") value)))

(defun to-char-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Byte") value)))

(defun to-char-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Int16") value)))

(defun to-char-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.UInt16") value)))

(defun to-char-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Int32") value)))

(defun to-char-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.UInt32") value)))

(defun to-char-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Int64") value)))

(defun to-char-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.UInt64") value)))

(defun to-char-string (value)
...
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.String") value)))

(defun to-char-single (value)
  "Calls System.Convert.ToChar ToChar(Single) -> Char. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Single") value)))

(defun to-char-double (value)
  "Calls System.Convert.ToChar ToChar(Double) -> Char. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Double") value)))

(defun to-char-decimal (value)
...
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Decimal") value)))

(defun to-char-date-time (value)
  "Calls System.Convert.ToChar ToChar(DateTime) -> Char. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.DateTime") value)))

(defun to-char-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-char-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information. This parameter is ignored.
"
  (dotnet:static <type-str> "ToChar" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-date-time (&rest args)
  "Passthrough for System.Convert.ToDateTime overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToDateTime" args))

(defun to-date-time-date-time (value)
...
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.DateTime") value)))

(defun to-date-time-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Object") value)))

(defun to-date-time-string (value)
...
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.String") value)))

(defun to-date-time-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.SByte") value)))

(defun to-date-time-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Byte") value)))

(defun to-date-time-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Int16") value)))

(defun to-date-time-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.UInt16") value)))

(defun to-date-time-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Int32") value)))

(defun to-date-time-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.UInt32") value)))

(defun to-date-time-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Int64") value)))

(defun to-date-time-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.UInt64") value)))

(defun to-date-time-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Boolean") value)))

(defun to-date-time-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Char") value)))

(defun to-date-time-single (value)
...
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Single") value)))

(defun to-date-time-double (value)
...
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Double") value)))

(defun to-date-time-decimal (value)
...
Parameters:
  - value (System.Decimal): The number to convert.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Decimal") value)))

(defun to-date-time-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-date-time-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDateTime" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-decimal (&rest args)
  "Passthrough for System.Convert.ToDecimal overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToDecimal" args))

(defun to-decimal-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Object") value)))

(defun to-decimal-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.SByte") value)))

(defun to-decimal-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Byte") value)))

(defun to-decimal-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Char") value)))

(defun to-decimal-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Int16") value)))

(defun to-decimal-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.UInt16") value)))

(defun to-decimal-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Int32") value)))

(defun to-decimal-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.UInt32") value)))

(defun to-decimal-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Int64") value)))

(defun to-decimal-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.UInt64") value)))

(defun to-decimal-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Single") value)))

(defun to-decimal-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Double") value)))

(defun to-decimal-string (value)
...
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.String") value)))

(defun to-decimal-decimal (value)
...
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Decimal") value)))

(defun to-decimal-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Boolean") value)))

(defun to-decimal-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.DateTime") value)))

(defun to-decimal-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-decimal-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDecimal" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-double (&rest args)
  "Passthrough for System.Convert.ToDouble overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToDouble" args))

(defun to-double-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Object") value)))

(defun to-double-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.SByte") value)))

(defun to-double-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Byte") value)))

(defun to-double-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Int16") value)))

(defun to-double-char (value)
  "Calls System.Convert.ToDouble ToDouble(Char) -> Double. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Char") value)))

(defun to-double-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.UInt16") value)))

(defun to-double-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Int32") value)))

(defun to-double-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.UInt32") value)))

(defun to-double-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Int64") value)))

(defun to-double-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.UInt64") value)))

(defun to-double-single (value)
...
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Single") value)))

(defun to-double-double (value)
...
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Double") value)))

(defun to-double-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Decimal") value)))

(defun to-double-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.String") value)))

(defun to-double-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Boolean") value)))

(defun to-double-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.DateTime") value)))

(defun to-double-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-double-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToDouble" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-hex-string (&rest args)
  "Passthrough for System.Convert.ToHexString overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToHexString" args))

(defun to-hex-string-byte[] (in-array)
...
Parameters:
  - in-array (System.Byte[]): An array of 8-bit unsigned integers.
"
  (dotnet:static <type-str> "ToHexString" (the (dotnet "System.Byte[]") in-array)))

(defun to-hex-string-byte[]-int32-int32 (in-array offset length)
...
Parameters:
  ...
  - length (System.Int32): The number of elements of inArray to convert.
"
  (dotnet:static <type-str> "ToHexString" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset) (the (dotnet "System.Int32") length)))

(defun to-hex-string-lower (&rest args)
  "Passthrough for System.Convert.ToHexStringLower overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToHexStringLower" args))

(defun to-hex-string-lower-byte[] (in-array)
...
Parameters:
  - in-array (System.Byte[]): An array of 8-bit unsigned integers.
"
  (dotnet:static <type-str> "ToHexStringLower" (the (dotnet "System.Byte[]") in-array)))

(defun to-hex-string-lower-byte[]-int32-int32 (in-array offset length)
...
Parameters:
  ...
  - length (System.Int32): The number of elements of inArray to convert.
"
  (dotnet:static <type-str> "ToHexStringLower" (the (dotnet "System.Byte[]") in-array) (the (dotnet "System.Int32") offset) (the (dotnet "System.Int32") length)))

(defun to-int16 (&rest args)
  "Passthrough for System.Convert.ToInt16 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToInt16" args))

(defun to-int16-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Object") value)))

(defun to-int16-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Boolean") value)))

(defun to-int16-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Char") value)))

(defun to-int16-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.SByte") value)))

(defun to-int16-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Byte") value)))

(defun to-int16-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.UInt16") value)))

(defun to-int16-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Int32") value)))

(defun to-int16-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.UInt32") value)))

(defun to-int16-int16 (value)
...
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Int16") value)))

(defun to-int16-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Int64") value)))

(defun to-int16-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.UInt64") value)))

(defun to-int16-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Single") value)))

(defun to-int16-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Double") value)))

(defun to-int16-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Decimal") value)))

(defun to-int16-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.String") value)))

(defun to-int16-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.DateTime") value)))

(defun to-int16-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int16-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int16-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToInt16" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-int32 (&rest args)
  "Passthrough for System.Convert.ToInt32 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToInt32" args))

(defun to-int32-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Object") value)))

(defun to-int32-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Boolean") value)))

(defun to-int32-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Char") value)))

(defun to-int32-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.SByte") value)))

(defun to-int32-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Byte") value)))

(defun to-int32-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Int16") value)))

(defun to-int32-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.UInt16") value)))

(defun to-int32-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.UInt32") value)))

(defun to-int32-int32 (value)
...
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Int32") value)))

(defun to-int32-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Int64") value)))

(defun to-int32-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.UInt64") value)))

(defun to-int32-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Single") value)))

(defun to-int32-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Double") value)))

(defun to-int32-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Decimal") value)))

(defun to-int32-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.String") value)))

(defun to-int32-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.DateTime") value)))

(defun to-int32-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int32-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int32-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToInt32" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-int64 (&rest args)
  "Passthrough for System.Convert.ToInt64 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToInt64" args))

(defun to-int64-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Object") value)))

(defun to-int64-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Boolean") value)))

(defun to-int64-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Char") value)))

(defun to-int64-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.SByte") value)))

(defun to-int64-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Byte") value)))

(defun to-int64-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Int16") value)))

(defun to-int64-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.UInt16") value)))

(defun to-int64-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Int32") value)))

(defun to-int64-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.UInt32") value)))

(defun to-int64-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.UInt64") value)))

(defun to-int64-int64 (value)
...
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Int64") value)))

(defun to-int64-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Single") value)))

(defun to-int64-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Double") value)))

(defun to-int64-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Decimal") value)))

(defun to-int64-string (value)
...
Parameters:
  - value (System.String): A string that contains a number to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.String") value)))

(defun to-int64-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.DateTime") value)))

(defun to-int64-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int64-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-int64-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToInt64" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-s-byte (&rest args)
  "Passthrough for System.Convert.ToSByte overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToSByte" args))

(defun to-s-byte-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Object") value)))

(defun to-s-byte-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Boolean") value)))

(defun to-s-byte-s-byte (value)
...
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.SByte") value)))

(defun to-s-byte-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Char") value)))

(defun to-s-byte-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Byte") value)))

(defun to-s-byte-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Int16") value)))

(defun to-s-byte-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.UInt16") value)))

(defun to-s-byte-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Int32") value)))

(defun to-s-byte-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.UInt32") value)))

(defun to-s-byte-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Int64") value)))

(defun to-s-byte-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.UInt64") value)))

(defun to-s-byte-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Single") value)))

(defun to-s-byte-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Double") value)))

(defun to-s-byte-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Decimal") value)))

(defun to-s-byte-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.String") value)))

(defun to-s-byte-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.DateTime") value)))

(defun to-s-byte-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-s-byte-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-s-byte-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToSByte" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-single (&rest args)
  "Passthrough for System.Convert.ToSingle overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToSingle" args))

(defun to-single-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Object") value)))

(defun to-single-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.SByte") value)))

(defun to-single-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Byte") value)))

(defun to-single-char (value)
  "Calls System.Convert.ToSingle ToSingle(Char) -> Single. Summary: Calling this method always throws System.InvalidCastException.
Returns: This conversion is not supported. No value is returned.
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Char") value)))

(defun to-single-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Int16") value)))

(defun to-single-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.UInt16") value)))

(defun to-single-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Int32") value)))

(defun to-single-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.UInt32") value)))

(defun to-single-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Int64") value)))

(defun to-single-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.UInt64") value)))

(defun to-single-single (value)
...
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Single") value)))

(defun to-single-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Double") value)))

(defun to-single-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Decimal") value)))

(defun to-single-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.String") value)))

(defun to-single-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Boolean") value)))

(defun to-single-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.DateTime") value)))

(defun to-single-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-single-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToSingle" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string (&rest args)
  "Passthrough for System.Convert.ToString overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToString" args))

(defun to-string-object (value)
...
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Object") value)))

(defun to-string-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Boolean") value)))

(defun to-string-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Char") value)))

(defun to-string-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.SByte") value)))

(defun to-string-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Byte") value)))

(defun to-string-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int16") value)))

(defun to-string-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt16") value)))

(defun to-string-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int32") value)))

(defun to-string-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt32") value)))

(defun to-string-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int64") value)))

(defun to-string-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt64") value)))

(defun to-string-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Single") value)))

(defun to-string-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Double") value)))

(defun to-string-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Decimal") value)))

(defun to-string-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.DateTime") value)))

(defun to-string-string (value)
...
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.String") value)))

(defun to-string-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-boolean-i-format-provider (value provider)
...
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Boolean") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-char-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information. This parameter is ignored.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Char") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-s-byte-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.SByte") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-byte-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Byte") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-int16-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int16") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-u-int16-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt16") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-int32-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int32") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-u-int32-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt32") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-int64-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int64") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-u-int64-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.UInt64") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-single-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Single") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-double-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Double") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-decimal-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Decimal") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-date-time-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.DateTime") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information. This parameter is ignored.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-string-byte-int32 (value to-base)
...
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Byte") value) (the (dotnet "System.Int32") to-base)))

(defun to-string-int16-int32 (value to-base)
...
Parameters:
  ...
  - to-base (System.Int32): The base of the return value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int16") value) (the (dotnet "System.Int32") to-base)))

(defun to-string-int32-int32 (value to-base)
...
Parameters:
  ...
  - to-base (System.Int32): The base of the return value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int32") value) (the (dotnet "System.Int32") to-base)))

(defun to-string-int64-int32 (value to-base)
...
Parameters:
  ...
  - to-base (System.Int32): The base of the return value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToString" (the (dotnet "System.Int64") value) (the (dotnet "System.Int32") to-base)))

(defun to-u-int16 (&rest args)
  "Passthrough for System.Convert.ToUInt16 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToUInt16" args))

(defun to-u-int16-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Object") value)))

(defun to-u-int16-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Boolean") value)))

(defun to-u-int16-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Char") value)))

(defun to-u-int16-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.SByte") value)))

(defun to-u-int16-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Byte") value)))

(defun to-u-int16-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Int16") value)))

(defun to-u-int16-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Int32") value)))

(defun to-u-int16-u-int16 (value)
...
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.UInt16") value)))

(defun to-u-int16-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.UInt32") value)))

(defun to-u-int16-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Int64") value)))

(defun to-u-int16-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.UInt64") value)))

(defun to-u-int16-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Single") value)))

(defun to-u-int16-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Double") value)))

(defun to-u-int16-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Decimal") value)))

(defun to-u-int16-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.String") value)))

(defun to-u-int16-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.DateTime") value)))

(defun to-u-int16-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int16-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int16-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToUInt16" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-u-int32 (&rest args)
  "Passthrough for System.Convert.ToUInt32 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToUInt32" args))

(defun to-u-int32-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Object") value)))

(defun to-u-int32-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Boolean") value)))

(defun to-u-int32-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Char") value)))

(defun to-u-int32-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.SByte") value)))

(defun to-u-int32-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Byte") value)))

(defun to-u-int32-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Int16") value)))

(defun to-u-int32-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.UInt16") value)))

(defun to-u-int32-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Int32") value)))

(defun to-u-int32-u-int32 (value)
...
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.UInt32") value)))

(defun to-u-int32-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Int64") value)))

(defun to-u-int32-u-int64 (value)
...
Parameters:
  - value (System.UInt64): The 64-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.UInt64") value)))

(defun to-u-int32-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Single") value)))

(defun to-u-int32-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Double") value)))

(defun to-u-int32-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Decimal") value)))

(defun to-u-int32-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.String") value)))

(defun to-u-int32-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.DateTime") value)))

(defun to-u-int32-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int32-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int32-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToUInt32" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))

(defun to-u-int64 (&rest args)
  "Passthrough for System.Convert.ToUInt64 overloads. Dispatches at runtime."
  (apply #'dotnet:static <type-str> "ToUInt64" args))

(defun to-u-int64-object (value)
...
Parameters:
  - value (System.Object): An object that implements the System.IConvertible interface, or .
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Object") value)))

(defun to-u-int64-boolean (value)
...
Parameters:
  - value (System.Boolean): The Boolean value to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Boolean") value)))

(defun to-u-int64-char (value)
...
Parameters:
  - value (System.Char): The Unicode character to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Char") value)))

(defun to-u-int64-s-byte (value)
...
Parameters:
  - value (System.SByte): The 8-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.SByte") value)))

(defun to-u-int64-byte (value)
...
Parameters:
  - value (System.Byte): The 8-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Byte") value)))

(defun to-u-int64-int16 (value)
...
Parameters:
  - value (System.Int16): The 16-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Int16") value)))

(defun to-u-int64-u-int16 (value)
...
Parameters:
  - value (System.UInt16): The 16-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.UInt16") value)))

(defun to-u-int64-int32 (value)
...
Parameters:
  - value (System.Int32): The 32-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Int32") value)))

(defun to-u-int64-u-int32 (value)
...
Parameters:
  - value (System.UInt32): The 32-bit unsigned integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.UInt32") value)))

(defun to-u-int64-int64 (value)
...
Parameters:
  - value (System.Int64): The 64-bit signed integer to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Int64") value)))

(defun to-u-int64-u-int64 (value)
...
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.UInt64") value)))

(defun to-u-int64-single (value)
...
Parameters:
  - value (System.Single): The single-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Single") value)))

(defun to-u-int64-double (value)
...
Parameters:
  - value (System.Double): The double-precision floating-point number to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Double") value)))

(defun to-u-int64-decimal (value)
...
Parameters:
  - value (System.Decimal): The decimal number to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Decimal") value)))

(defun to-u-int64-string (value)
...
Parameters:
  - value (System.String): A string that contains the number to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.String") value)))

(defun to-u-int64-date-time (value)
...
Parameters:
  - value (System.DateTime): The date and time value to convert.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.DateTime") value)))

(defun to-u-int64-object-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.Object") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int64-string-i-format-provider (value provider)
...
Parameters:
  ...
  - provider (System.IFormatProvider): An object that supplies culture-specific formatting information.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.String") value) (the (dotnet "System.IFormatProvider") provider)))

(defun to-u-int64-string-int32 (value from-base)
...
Parameters:
  ...
  - from-base (System.Int32): The base of the number in value, which must be 2, 8, 10, or 16.
"
  (dotnet:static <type-str> "ToUInt64" (the (dotnet "System.String") value) (the (dotnet "System.Int32") from-base)))
