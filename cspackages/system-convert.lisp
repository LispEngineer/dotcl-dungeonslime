...
(cl:defun to-base64-string (in-array cl:&optional (options cl:nil supplied-options) (length cl:nil supplied-length) (options cl:nil supplied-options))
  ...
  (cl:cond
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:numberp options) supplied-length (cl:numberp length) supplied-options (cl:or (cl:null options) (dotnet:object-type options)))
     (dotnet:static <type-str> "ToBase64String" in-array options length options))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:numberp options) supplied-length (cl:numberp length) (cl:not supplied-options))
     (dotnet:static <type-str> "ToBase64String" in-array options length))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:or (cl:null options) (dotnet:object-type options)) (cl:not supplied-length) (cl:not supplied-options))
     (dotnet:static <type-str> "ToBase64String" in-array options))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) supplied-options (cl:or (cl:null options) (dotnet:object-type options)) (cl:not supplied-length) (cl:not supplied-options))
     (dotnet:static <type-str> "ToBase64String" in-array options))
    ((cl:and (cl:or (cl:null in-array) (dotnet:object-type in-array)) (cl:not supplied-options) (cl:not supplied-length) (cl:not supplied-options))
