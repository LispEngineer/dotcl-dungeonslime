...
Generation date: 2026-07-03T12:03:34Z
...
"
  :components (
   ...
   (:file "system-uri-kind")
   (:file "system-uri")
   (:file "system-convert")
   (:file "system-app-domain")
   (:file "system-io-path")
   (:file "system-boolean")
   (:file "system-type")
   (:file "system-object")
   (:file "system-single")
   (:file "system-double")
   (:file "system-reflection-member-info")
   (:file "microsoft-xna-framework-vector2")
   (:file "microsoft-xna-framework-rectangle")
   (:file "microsoft-xna-framework-point")
   (:file "microsoft-xna-framework-game-time")
   (:file "microsoft-xna-framework-game")
   (:file "microsoft-xna-framework-game-window")
   (:file "microsoft-xna-framework-input-keyboard")
   (:file "microsoft-xna-framework-input-keyboard-state")
   (:file "microsoft-xna-framework-input-keys")
   (:file "microsoft-xna-framework-input-mouse")
   (:file "microsoft-xna-framework-input-mouse-state")
   (:file "microsoft-xna-framework-input-button-state")
   (:file "microsoft-xna-framework-input-game-pad")
   (:file "microsoft-xna-framework-input-game-pad-state")
   (:file "microsoft-xna-framework-input-game-pad-d-pad")
   (:file "microsoft-xna-framework-input-game-pad-thumb-sticks")
   (:file "microsoft-xna-framework-input-game-pad-triggers")
   (:file "microsoft-xna-framework-input-buttons")
   (:file "microsoft-xna-framework-input-touch-touch-panel")
   (:file "microsoft-xna-framework-input-touch-touch-collection")
   (:file "microsoft-xna-framework-input-touch-touch-location")
   (:file "microsoft-xna-framework-input-touch-gesture-sample")
   (:file "microsoft-xna-framework-color")
   (:file "microsoft-xna-framework-content-content-manager")
   (:file "microsoft-xna-framework-graphics-device-manager")
   (:file "microsoft-xna-framework-graphics-sprite-effects")
   (:file "microsoft-xna-framework-graphics-sprite-sort-mode")
   (:file "microsoft-xna-framework-graphics-sampler-state")
   (:file "microsoft-xna-framework-graphics-graphics-device")
   (:file "microsoft-xna-framework-graphics-sprite-batch")
   (:file "microsoft-xna-framework-graphics-sprite-font")
   (:file "microsoft-xna-framework-graphics-sprite-font-glyph")
   (:file "microsoft-xna-framework-graphics-presentation-parameters")
   (:file "microsoft-xna-framework-player-index")
   (:file "microsoft-xna-framework-audio-sound-effect")
   (:file "microsoft-xna-framework-audio-sound-effect-instance")
   (:file "microsoft-xna-framework-audio-sound-state")
   (:file "microsoft-xna-framework-media-song")
   (:file "microsoft-xna-framework-media-media-player")
  ))
