...
Generation date: 2026-07-03T12:55:23Z
...
"
  :components (
   (:file "packages")
   (:file "system-console" :depends-on ("packages"))
   (:file "system-time-span" :depends-on ("packages"))
   (:file "system-uri-kind" :depends-on ("packages"))
   (:file "system-uri" :depends-on ("packages"))
   (:file "system-convert" :depends-on ("packages"))
   (:file "system-app-domain" :depends-on ("packages"))
   (:file "system-io-path" :depends-on ("packages"))
   (:file "system-boolean" :depends-on ("packages"))
   (:file "system-type" :depends-on ("packages"))
   (:file "system-object" :depends-on ("packages"))
   (:file "system-single" :depends-on ("packages"))
   (:file "system-double" :depends-on ("packages"))
   (:file "system-reflection-member-info" :depends-on ("packages"))
   (:file "microsoft-xna-framework-vector2" :depends-on ("packages"))
   (:file "microsoft-xna-framework-rectangle" :depends-on ("packages"))
   (:file "microsoft-xna-framework-point" :depends-on ("packages"))
   (:file "microsoft-xna-framework-game-time" :depends-on ("packages"))
   (:file "microsoft-xna-framework-game" :depends-on ("packages"))
   (:file "microsoft-xna-framework-game-window" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-keyboard" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-keyboard-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-keys" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-mouse" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-mouse-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-button-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-game-pad" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-game-pad-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-game-pad-d-pad" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-game-pad-thumb-sticks" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-game-pad-triggers" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-buttons" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-touch-touch-panel" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-touch-touch-collection" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-touch-touch-location" :depends-on ("packages"))
   (:file "microsoft-xna-framework-input-touch-gesture-sample" :depends-on ("packages"))
   (:file "microsoft-xna-framework-color" :depends-on ("packages"))
   (:file "microsoft-xna-framework-content-content-manager" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-device-manager" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sprite-effects" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sprite-sort-mode" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sampler-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-graphics-device" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sprite-batch" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sprite-font" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-sprite-font-glyph" :depends-on ("packages"))
   (:file "microsoft-xna-framework-graphics-presentation-parameters" :depends-on ("packages"))
   (:file "microsoft-xna-framework-player-index" :depends-on ("packages"))
   (:file "microsoft-xna-framework-audio-sound-effect" :depends-on ("packages"))
   (:file "microsoft-xna-framework-audio-sound-effect-instance" :depends-on ("packages"))
   (:file "microsoft-xna-framework-audio-sound-state" :depends-on ("packages"))
   (:file "microsoft-xna-framework-media-song" :depends-on ("packages"))
   (:file "microsoft-xna-framework-media-media-player" :depends-on ("packages"))
  ))
