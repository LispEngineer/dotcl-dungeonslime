...
;;; Creation Date: 2026-07-03T01:18:33Z
...
(cl:defconstant <creation> "2026-07-03T01:18:33Z")
...
(cl:defun get-capabilities (player-index)
  ...
  (cl:cond
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)))
...
(cl:defun get-state (player-index cl:&optional (dead-zone-mode cl:nil supplied-dead-zone-mode) (right-dead-zone-mode cl:nil supplied-right-dead-zone-mode))
  ...
  (cl:cond
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)) supplied-dead-zone-mode (cl:or (cl:null dead-zone-mode) (monoutils:dotnet-p dead-zone-mode)) supplied-right-dead-zone-mode (cl:or (cl:null right-dead-zone-mode) (monoutils:dotnet-p right-dead-zone-mode)))
     (dotnet:static <type-str> "GetState" player-index dead-zone-mode right-dead-zone-mode))
    ((cl:and (cl:numberp player-index) supplied-dead-zone-mode (cl:or (cl:null dead-zone-mode) (monoutils:dotnet-p dead-zone-mode)) supplied-right-dead-zone-mode (cl:or (cl:null right-dead-zone-mode) (monoutils:dotnet-p right-dead-zone-mode)))
     (dotnet:static <type-str> "GetState" player-index dead-zone-mode right-dead-zone-mode))
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)) supplied-dead-zone-mode (cl:or (cl:null dead-zone-mode) (monoutils:dotnet-p dead-zone-mode)) (cl:not supplied-right-dead-zone-mode))
     (dotnet:static <type-str> "GetState" player-index dead-zone-mode))
    ((cl:and (cl:numberp player-index) supplied-dead-zone-mode (cl:or (cl:null dead-zone-mode) (monoutils:dotnet-p dead-zone-mode)) (cl:not supplied-right-dead-zone-mode))
     (dotnet:static <type-str> "GetState" player-index dead-zone-mode))
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)) (cl:not supplied-dead-zone-mode) (cl:not supplied-right-dead-zone-mode))
...
(cl:defun set-vibration (player-index left-motor right-motor cl:&optional (left-trigger cl:nil supplied-left-trigger) (right-trigger cl:nil supplied-right-trigger))
  ...
  (cl:cond
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)) (cl:numberp left-motor) (cl:numberp right-motor) supplied-left-trigger (cl:numberp left-trigger) supplied-right-trigger (cl:numberp right-trigger))
    ...
    ((cl:and (cl:numberp player-index) (cl:numberp left-motor) (cl:numberp right-motor) supplied-left-trigger (cl:numberp left-trigger) supplied-right-trigger (cl:numberp right-trigger))
     (dotnet:static <type-str> "SetVibration" player-index left-motor right-motor left-trigger right-trigger))
    ((cl:and (cl:or (cl:null player-index) (monoutils:dotnet-p player-index)) (cl:numberp left-motor) (cl:numberp right-motor) (cl:not supplied-left-trigger) (cl:not supplied-right-trigger))
