...
"
  (cl:cond
    ((cl:and supplied-format (cl:stringp format) supplied-provider (cl:or (cl:null provider) (dotnet:is-instance-of provider "System.IFormatProvider")))
    ...
    ((cl:and supplied-format (cl:or (cl:null format) (dotnet:is-instance-of format "System.IFormatProvider")) (cl:not supplied-provider))
     (dotnet:invoke (cl:the (dotnet "System.Double") obj!) "ToString" format))
...
(cl:defun try-format (obj! destination format cl:&key (provider cl:nil supplied-provider))
  "Master wrapper for System.Double.TryFormat out-only overloads. Dispatches at runtime. Each out parameter is returned as an additional cl:values result (after the primary return value), in C# declaration order.
...
TryFormat(Char], out Int32&, Char] = default(System.ReadOnlySpan`1[System.Char]) [C# default of type System.ReadOnlySpan`1[System.Char] -- not representable in Lisp, must be supplied], IFormatProvider = null) -> Boolean
  Summary: Tries to format the value of the current double instance into the provided span of characters.
  ...
  Parameters:
    ...
    - format (System.ReadOnlySpan`1[System.Char]): A span containing the characters that represent a standard or custom format string that defines the acceptable format for destination.
...
(cl:defun try-parse (s cl:&optional (provider cl:nil supplied-provider) (provider2 cl:nil supplied-provider2))
  "Master wrapper for System.Double.TryParse out-only overloads. Dispatches at runtime. Each out parameter is returned as an additional cl:values result (after the primary return value), in C# declaration order.
...
TryParse(String, out Double&) -> Boolean
  ...
  Parameters:
    ...
    - result (System.Double&): When this method returns, contains the double-precision floating-point number equivalent of the s parameter, if the conversion succeeded, or zero if the conversion failed. The conversion fails if the s parameter is or System.String.Empty or is not a number in a valid format. It also fails on .NET Framework and .NET Core 2.2 and earlier versions if s represents a number less than System.Double.MinValue or greater than System.Double.MaxValue. This parameter is passed uninitialized; any value originally supplied in result will be overwritten.

TryParse(Char], out Double&) -> Boolean
  Summary: Converts the span representation of a number in a specified style and culture-specific format to its double-precision floating-point number equivalent. A return value indicates whether the conversion succeeded or failed.
  Returns: if s was converted successfully; otherwise, .
  Parameters:
    - s (System.ReadOnlySpan`1[System.Char]): A character span that contains the string representation of the number to convert.
    - result (System.Double&): When this method returns, contains the double-precision floating-point number equivalent of the numeric value or symbol contained in s parameter, if the conversion succeeded, or zero if the conversion failed. The conversion fails if the s parameter is or empty. If s is a valid number less than System.Double.MinValue, result is System.Double.NegativeInfinity. If s is a valid number greater than System.Double.MaxValue, result is System.Double.PositiveInfinity. This parameter is passed uninitialized; any value originally supplied in result will be overwritten.

TryParse(Byte], out Double&) -> Boolean
  Summary: Tries to convert a UTF-8 character span containing the string representation of a number to its double-precision floating-point number equivalent.
...
TryParse(String, IFormatProvider, out Double&) -> Boolean
  ...
  Parameters:
    ...
    - provider (System.IFormatProvider): An object that provides culture-specific formatting information about s.
    - result (System.Double&): When this method returns, contains the result of successfully parsing s or an undefined value on failure.
...
TryParse(Byte], IFormatProvider, out Double&) -> Boolean
  ...
  Parameters:
    - utf8-text (System.ReadOnlySpan`1[System.Byte]): The span of UTF-8 characters to parse.
    - provider (System.IFormatProvider): An object that provides culture-specific formatting information about utf8Text.
    - result (System.Double&): On return, contains the result of successfully parsing utf8Text or an undefined value on failure.
...
TryParse(String, NumberStyles, IFormatProvider, out Double&) -> Boolean
  ...
  Parameters:
    - s (System.String): A string containing a number to convert.
    - style (System.Globalization.NumberStyles): A bitwise combination of System.Globalization.NumberStyles values that indicates the permitted format of s. A typical value to specify is System.Globalization.NumberStyles.Float combined with System.Globalization.NumberStyles.AllowThousands.
    - provider (System.IFormatProvider): An System.IFormatProvider that supplies culture-specific formatting information about s.
    - result (System.Double&): When this method returns, contains a double-precision floating-point number equivalent of the numeric value or symbol contained in s, if the conversion succeeded, or zero if the conversion failed. The conversion fails if the s parameter is or System.String.Empty or is not in a format compliant with style, or if style is not a valid combination of System.Globalization.NumberStyles enumeration constants. It also fails on .NET Framework or .NET Core 2.2 and earlier versions if s represents a number less than System.SByte.MinValue or greater than System.SByte.MaxValue. This parameter is passed uninitialized; any value originally supplied in result will be overwritten.

TryParse(Char], NumberStyles, IFormatProvider, out Double&) -> Boolean
  Summary: Converts a character span containing the string representation of a number in a specified style and culture-specific format to its double-precision floating-point number equivalent. A return value indicates whether the conversion succeeded or failed.
  Returns: if s was converted successfully; otherwise, .
  Parameters:
    - s (System.ReadOnlySpan`1[System.Char]): A read-only character span that contains the number to convert.
    - style (System.Globalization.NumberStyles): A bitwise combination of System.Globalization.NumberStyles values that indicates the permitted format of s. A typical value to specify is System.Globalization.NumberStyles.Float combined with System.Globalization.NumberStyles.AllowThousands.
    - provider (System.IFormatProvider): An object that supplies culture-specific formatting information about s.
    - result (System.Double&): When this method returns and if the conversion succeeded, contains a double-precision floating-point number equivalent of the numeric value or symbol contained in s. Contains zero if the conversion failed. The conversion fails if the s parameter is , an empty character span, or not a number in a format compliant with style. If s is a valid number less than System.Double.MinValue, result is System.Double.NegativeInfinity. If s is a valid number greater than System.Double.MaxValue, result is System.Double.PositiveInfinity. This parameter is passed uninitialized; any value originally supplied in result will be overwritten.
