...
;;; Creation Date: 2026-06-30T03:10:29Z
...
(cl:defconstant <creation> "2026-06-30T03:10:29Z")
...
(cl:setf (cl:documentation (cl:quote +na-n+) (cl:quote cl:variable)) "Represents a value that is not a number (). This field is constant.")
...
(cl:defun compare-to (obj cl:&rest args)
  "Passthrough for System.Double.CompareTo overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Double") obj) "CompareTo" args))
...
(cl:defun equals (obj cl:&rest args)
  "Passthrough for System.Double.Equals overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Double") obj) "Equals" args))
...
(cl:defun is-negative-infinity (d)
...
(cl:defun is-positive-infinity (d)
...
(cl:defun log (cl:&rest args)
  "Passthrough for System.Double.Log overloads. Dispatches at runtime."
...
(cl:defun parse (cl:&rest args)
  "Passthrough for System.Double.Parse overloads. Dispatches at runtime."
...
(cl:defun round (cl:&rest args)
  "Passthrough for System.Double.Round overloads. Dispatches at runtime."
...
(cl:defun to-string (obj cl:&rest args)
  "Passthrough for System.Double.ToString overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "System.Double") obj) "ToString" args))
