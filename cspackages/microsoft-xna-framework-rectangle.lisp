...
;;; Creation Date: 2026-06-29T01:13:05Z
...
(cl:defconstant <creation> "2026-06-29T01:13:05Z")
...
(cl:defun contains (obj cl:&rest args)
  "Passthrough for Microsoft.Xna.Framework.Rectangle.Contains overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "Microsoft.Xna.Framework.Rectangle") obj) "Contains" args))
...
(cl:defun equals (obj cl:&rest args)
  ...
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "Microsoft.Xna.Framework.Rectangle") obj) "Equals" args))
...
(cl:defun inflate (obj cl:&rest args)
  "Passthrough for Microsoft.Xna.Framework.Rectangle.Inflate overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "Microsoft.Xna.Framework.Rectangle") obj) "Inflate" args))
...
(cl:defun offset (obj cl:&rest args)
  "Passthrough for Microsoft.Xna.Framework.Rectangle.Offset overloads. Dispatches at runtime."
  (cl:apply (cl:function dotnet:invoke) (cl:the (dotnet "Microsoft.Xna.Framework.Rectangle") obj) "Offset" args))
