...
(cl:defvar %eight-cache% csharp-assembly-utils:+unbound-marker+)
(cl:define-symbol-macro +eight+
  (cl:if (cl:eq %eight-cache% csharp-assembly-utils:+unbound-marker+)
      (cl:setf %eight-cache% (dotnet:static <type-str> "Eight"))
      %eight-cache%))
...
;; a copy. See FEATURES.md's "Static Constants and Symbol Macros"
;; section and doc/generator-design-notes.md for the full explanation.
(cl:defvar %five-cache% csharp-assembly-utils:+unbound-marker+)
(cl:define-symbol-macro +five+
  (cl:if (cl:eq %five-cache% csharp-assembly-utils:+unbound-marker+)
      (cl:setf %five-cache% (dotnet:static <type-str> "Five"))
      %five-cache%))
...
;; a copy. See FEATURES.md's "Static Constants and Symbol Macros"
;; section and doc/generator-design-notes.md for the full explanation.
(cl:defvar %seven-cache% csharp-assembly-utils:+unbound-marker+)
(cl:define-symbol-macro +seven+
  (cl:if (cl:eq %seven-cache% csharp-assembly-utils:+unbound-marker+)
      (cl:setf %seven-cache% (dotnet:static <type-str> "Seven"))
      %seven-cache%))
...
;; a copy. See FEATURES.md's "Static Constants and Symbol Macros"
;; section and doc/generator-design-notes.md for the full explanation.
(cl:defvar %six-cache% csharp-assembly-utils:+unbound-marker+)
(cl:define-symbol-macro +six+
  (cl:if (cl:eq %six-cache% csharp-assembly-utils:+unbound-marker+)
      (cl:setf %six-cache% (dotnet:static <type-str> "Six"))
      %six-cache%))
