...
(cl:defconstant <type> (dotnet:resolve-type "Microsoft.Xna.Framework.Input.ButtonState"))
...
;; the defconstant form below only runs once. If Microsoft.Xna.Framework.Input.ButtonState is a mutable
