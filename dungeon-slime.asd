  ...
  :components #.(append
                 ...
                 *cspackages-components*
                 (list
                  ...
                  '(:file "test-harness" :depends-on ("clr-defmethod-test" "poc-test" "clr-generic-test" "package-generator-tests" "load-system-test" "texture-atlas" "utils" "mg-classes" "game-1" "typed-calls-test"))
