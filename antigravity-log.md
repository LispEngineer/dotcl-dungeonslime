...
| July 4, 2026 | [title-scene.lisp](title-scene.lisp) | Modified | Updated to load and use the larger fonts/04B_30_5x spritefont on the title screen. |
...
- **Title Screen 5x Font Loading**: Configured the title screen (`title-scene.lisp`) to load and use the newly added larger pixel font `"fonts/04B_30_5x"` instead of the standard gameplay-sized font, fulfilling the original Chapter 17 layout specifications.
